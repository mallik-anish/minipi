...
-(NSArray *)getCropImage:(UIImageView *)mainImage aryPoint:(NSMutableArray *)cropImgSelect
{
   ...
   [self getCoordinateValue:cropImgSelect];
    ...
    NSArray *array=[NSArray arrayWithObjects:[UIImage imageWithCGImage:imag],[NSString stringWithFormat:@"%f",minX],[NSString stringWithFormat:@"%f",minY],[NSString stringWithFormat:@"%f",(maxX-minX)],[NSString stringWithFormat:@"%f",(maxY-minY)], nil];
    NSLog(@"%d",array.count);
    return array;
